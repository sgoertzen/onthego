...
storiesOf('posts/Post Comment', module)
    .add('Yesterday', () => {
        ...
        let yesterdayAtSevenThirteen = new Date()
        ...
        let yesterdayAtSevenThirteenTS = new TimeStamp(yesterdayAtSevenThirteen.getTime())
        const c = new Comment("Bob", "I said something", yesterdayAtSevenThirteenTS)
        return (<PostComment {...c} />)
    })
    .add("Month Ago", () => {
        let julyFirstDate = new Date("7/1/2019")
        let julyFirst = new TimeStamp(julyFirstDate.getTime())

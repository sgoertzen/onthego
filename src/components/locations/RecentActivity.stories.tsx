...
storiesOf('locations/Recent Activity', module)
    .add('comment', () => {
        ...
        return (<RecentActivity {...activity} onClick={() => {}}/>)
    })
    .add('post', () => {
        const activity:IRecentActivity = {
            Author: "Bob",
